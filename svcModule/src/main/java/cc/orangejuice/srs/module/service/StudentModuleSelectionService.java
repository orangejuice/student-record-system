...
public class StudentModuleSelectionService {
    ...
    public List<StudentModuleSelectionDTO> findAllStudentSelectionsByAcademicYearAndAcademicSemester(Integer academicYear, Integer academicSemester) {
        log.debug("Request to get all student selections for academicYear: {}, academicSemester: {}",
            academicYear, academicSemester);
        List<StudentModuleSelection> studentModuleSelections = studentModuleSelectionRepository.findAllByAcademicYearAndAcademicSemester(academicYear, academicSemester);
        List<StudentModuleSelectionDTO> returnList = studentModuleSelectionMapper.toDto(studentModuleSelections);
        return returnList;
    }
